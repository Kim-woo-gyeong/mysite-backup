...
$(function(){
	...
	$('#add-form').submit(function(event){
		...
		if(vo.name == ''){
			//alert('이름이 비어있습니다.');
			messageBox("방벙록 글 남기기", "이름은 필수 항목입니다.", function(){
				$("#input-name").focus();
			});
			return;
		}
		...
		if(vo.password == ''){
			messageBox("방벙록 글 남기기", "비밀번호는 필수 항목입니다.",function(){
		...
		if(vo.contents == ''){
			messageBox("방벙록 글 남기기", "내용은 필수 항목입니다.",function(){
				$("#tx-content").focus();
			});
			return;
		}
...
<body>
	<div id="container">
		...
		<jsp:include page="/WEB-INF/views/includes/navigation.jsp">
			<jsp:param name="menu" value="guestbook-ajax"/>
		</jsp:include>
